set -o vi
alias ls='ls -F --color'
alias t='tree --dirsfirst -ChFL 1 --sort=size'
# alias t2='tree --dirsfirst -ChFL 2 --sort=size'
alias nvim='nvim-qt -qwindowgeometry 1000x600'
# alias nvim='nvim-gtk'
...
if [ "$MSYSTEM" = "MSYS" ]; then
    GPG4WIN="/c/Program Files (x86)/GnuPG/bin"
    GITWIN="/c/Program Files/Git/mingw64/bin"
    # SYSPYTHON=/c/Python36/Scripts:/c/Python36
    SYSPYTHON=$HOME/scoop/apps/python/3.7.0/Scripts:$HOME/scoop/apps/python/3.7.0
    VIM="/c/Program Files (x86)/vim/vim80"
    CHOCO=/c/ProgramData/chocolatey/bin:/c/ProgramData/chocolatey/lib/mpv.install/tools
    ...
    # NODEJS="$HOME/scoop/apps/nodejs/current"
    YARN="$HOME/scoop/apps/yarn/current/Yarn/bin"
    YARNBIN="$HOME/AppData/Local/Yarn/Data/global/node_modules/.bin"
    MSBUILD="/c/Program Files (x86)/MSBuild/14.0/Bin"
    LOCALNPM="/c/Users/deocampo/AppData/Roaming/npm"

    export PATH=$GPG4WIN:$PATH
    export PATH=$GITWIN:$PATH
    export PATH=$PATH:$SYSPYTHON:$VIM:$CHOCO:$MIKTEX:$YARN:$YARNBIN
    export PATH=$PATH:$USERYARN:$NODEJS:$YARN:$MSBUILD:$LOCALNPM
...
export REPO=$HOME/opt/repos/wvc
export SHP=$REPO/ecomm/shopify-store

# ============================================================================
# Scoop
# ============================================================================

SCOOP_BIN=$HOME/scoop/shims
export PATH=$SCOOP_BIN:$PATH
...
export PG_HOME="$HOME/scoop/apps/postgresql/current"
...
# export neovim-gtk location
export PATH=$PATH:$HOME/opt/neovim-gtk/bin
...
export PATH=$PATH:$HOME/scoop/apps/dotnet-sdk/current
...
# Force which perl library git uses
export GITPERLLIB="/c/Program Files/Git/mingw64/share/perl5"

# Git flow
source $BASH_HOME/.config/bash/bash_completion.d/git-flow-completion.bash

# Git prompt
# source $BASH_HOME/.config/git/git-prompt.sh
...
alias start-docker=". $HOME/.local/bin/start-docker.sh"

# ============================================================================
# Misc tools
# ============================================================================
VALE_DIR="/c/Program Files (x86)/Vale"
export PATH=$PATH:$VALE_DIR

# ============================================================================
# Setup home bin
# ============================================================================

# HOMEBIN should come first before everything
